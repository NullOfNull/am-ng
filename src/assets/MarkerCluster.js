...
(function () {
    ...
    var MarkerClusterer =
        ...
        BMapLib.MarkerClusterer = function (map, options) {
            ...
            this._updateTextFunc = opts["updateText"] ||
                function (markers) {
    ...
    MarkerClusterer.prototype.setUpdateTextFunc = function (func) {
        this._updateTextFunc = func ||
            function (markers) {
                return markers.length;
            }
    }
    ...
    Cluster.prototype.updateClusterMarker = function () {
        ...
        this._clusterMarker.setText(this._markerClusterer._updateTextFunc(this._markers))
